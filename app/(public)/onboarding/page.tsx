...
//                         h-[55vh] lg:h-full lg:min-h-0 rounded-2xl lg:rounded-none overscroll-x-contain touch-pan-x"
//               >
...
//                 }
//                 className="mt-8 w-full rounded-full bg-[#9F86C0] px-6 py-3
...
//           <div className="mt-3">
//             <button
//               className="w-full rounded-full bg-[#9F86C0] px-6 py-4 text-sm font-semibold text-white hover:bg-white/90"
//               onClick={
//                 activeIndex === slides.length - 1
//                   ? goToChoicesRoles
//                   : () => goToSlide(activeIndex + 1)
